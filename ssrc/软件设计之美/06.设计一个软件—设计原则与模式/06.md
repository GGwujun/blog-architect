...
比如，Visitor模式主要是因为C加加、Java之类的语言只支持单分发，也就是只能根据一个对象来决定调用哪个方法。而对于支持多分发的语言，Visitor模式存在的意义就不大了。
...
![](./httpsstatic001geekbangorgresourceimage4f364f01c17b5509c29085b166a7ccec6c36.jpg)
